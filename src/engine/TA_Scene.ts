...
import { TA_SceneCamera } from "./TA_SceneCamera";
...
export class TA_Scene {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.camera = new TA_SceneCamera().camera;
    this.renderer = new WebGLRenderer({ antialias: true, canvas, alpha: true });
    this.renderer.setSize(canvas.clientWidth, canvas.clientHeight);

    //TODO сделать опционально
    canvas.style.background =
      "linear-gradient(0deg, rgba(188,254,255,1) 0%, rgba(226,244,247,1) 50%, rgba(219,242,246,1) 100%)";
    ...
    if (container) {
      console.log("labelRenderer added");
...
// export class TA_Scene {
//   static exist: any;
//   static instance: TA_Scene;
//   ta_UI: any;
//   scene: any;
//   mousePosition: { x: null; y: null; };
//   mode: { action: string; entity: null; };
//   ta_State: TA_State = new TA_State;
//   events: EventEmitter = new EventEmitter;
//   meshEditObject: {};
//   selectableObjects: never[] = [];
//   tempSelectableObjects: never[] = [];
//   currentSelection: { object: null; objectOwnColor: null; multiselection: any; };
//   transformControlsMode: string;
//   transformControlsChanged: boolean = false;
//   orbitControlsChanged: boolean = false;
//   orbitControls: any;
