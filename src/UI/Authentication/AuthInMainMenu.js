...
export default function AuthInMainMenu() {
	...
	const unlogged = 
		...
		let loggedIn = <div className='authentication-welcome'>Welcome,
				<span onClick={showUsermenu} className='authentication-link'>{ta_State.state.userName}</span>
		</div>
	...
	return(
		<div className='auth-in-mainMenu'>
			...
			<UserMenu userName={ta_State.state.userName} showUsermenu={showUsermenu} ></UserMenu> 
			}
		</div>
		// 
	)
